    ...
    <div class="row">
        <div class="col-12">
            <table width="100%" cellpadding="5" cellspacing="5">
                ...
                <tr>
                    <td>
                        <form name="addshipping" method="post" action="addshipping.php">
                            <table width="100%" cellspacing="5" cellpadding="5" class="table table-striped">
                                <tr>
                                    ...
                                    <td><input type="text" name="customers_id" style="width: 250px; height: 30px;"/></td>
                                </tr>
                                <tr>
                                    <td style="width: 120px; text-align: right; font-weight: bold;">Carts ID :</td>
                                    <td><input type="text" name="carts_id" style="width: 250px; height: 30px;"/></td>
                                </tr>
								<tr>
                                    <td style="width: 120px; text-align: right; font-weight: bold;">Products ID :</td>
                                    <td><input type="text" name="products_id" style="width: 250px; height: 30px;"/></td>
								</tr>
                                <tr>
								...
								<tr>
                                    ...
                                    <td><input type="text" name="shipping_address" style="width: 250px; height: 30px;"/></td>
								</tr>
                                <tr>
